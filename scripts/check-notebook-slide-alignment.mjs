...
for (const slidePath of slidePaths) {
  ...
  assert.equal(slideSections.length, 37, `${slidePath} must contain 37 slides`);
...
console.log("Workshop 2 alignment passed: 37 slides, two 61-cell notebooks, exact datasets, outputs, larger blanks, and full/excerpt mappings are synchronised.");
